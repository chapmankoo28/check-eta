...
type MarkerContextValue = {
  ...
  map: MapLibreGL.Map | null
  defaultOpenRef: React.RefObject<boolean>
}
...
function MapMarker({
  ...
  return (
    <MarkerContext.Provider value={{ marker, map, defaultOpenRef }}>
      {children}
...
type MarkerPopupProps = {
  ...
  closeButton?: boolean
  /** CUSTOM: Open the popup automatically when the marker is added to the map (default: false) */
  defaultOpen?: boolean
...
function MarkerPopup({
  ...
  const { marker, map, defaultOpenRef } = useMarkerContext()
  ...
  useEffect(() => {
    if (!map || !marker.getElement().isConnected) return
